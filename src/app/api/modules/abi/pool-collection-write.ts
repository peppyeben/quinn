export const POOL_COLLECTION_WRITE_ABI = [
    {
        inputs: [
            {
            ...
            { internalType: "contract IMasterVault", name: "initMasterVault", type: "address" },
            {
                internalType: "contract IExternalProtectionVault",
                name: "initExternalProtectionVault",
                type: "address",
            },
            { internalType: "contract IPoolToken", name: "initBNTPoolToken", type: "address" },
            { internalType: "address", name: "carbonPOL", type: "address" },
        ],
    ...
    { inputs: [], name: "NotWhitelistedForPOL", type: "error" },
    { inputs: [], name: "Overflow", type: "error" },
    { inputs: [], name: "PoolNotInSurplus", type: "error" },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: "contract Token", name: "token", type: "address" },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: "bytes32", name: "contextId", type: "bytes32" },
            { indexed: true, internalType: "contract Token", name: "token", type: "address" },
        ...
        inputs: [
            {
                ...
                name: "oldMinNetworkFeeBurn",
                type: "uint256",
            },
            {
                indexed: false,
                internalType: "uint256",
                name: "newMinNetworkFeeBurn",
                type: "uint256",
            },
        ],
        name: "MinNetworkFeeBurnUpdated",
        type: "event",
    },
    {
        anonymous: false,
        ...
        name: "NetworkFeesBurned",
        type: "event",
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: "uint32", name: "oldRewardsPPM", type: "uint32" },
            { indexed: false, internalType: "uint32", name: "newRewardsPPM", type: "uint32" },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: "uint256", name: "polTokenAmount", type: "uint256" },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: "contract Token", name: "pool", type: "address" },
            {
                indexed: true,
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: "uint16", name: "poolType", type: "uint16" },
            {
                indexed: true,
                internalType: "contract IPoolCollection",
                name: "poolCollection",
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, internalType: "bytes32", name: "contextId", type: "bytes32" },
            { indexed: true, internalType: "contract Token", name: "sourceToken", type: "address" },
            { indexed: true, internalType: "contract Token", name: "targetToken", type: "address" },
            { indexed: false, internalType: "uint256", name: "sourceAmount", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "targetAmount", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "bntAmount", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "targetFeeAmount", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "bntFeeAmount", type: "uint256" },
    ...
    },
    {
        inputs: [
            ...
            { internalType: "contract IPoolCollection", name: "poolCollection", type: "address" },
        ],
        name: "createPools",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    {
        inputs: [
            { internalType: "contract IBNTPool", name: "initBNTPool", type: "address" },
            {
                internalType: "contract IPendingWithdrawals",
                name: "initPendingWithdrawals",
                type: "address",
            },
            { internalType: "contract IPoolMigrator", name: "initPoolMigrator", type: "address" },
        ],
        name: "initialize",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    {
        inputs: [{ internalType: "uint256", name: "newMinNetworkFeeBurn", type: "uint256" }],
        name: "setMinNetworkFeeBurn",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    },
    {
        inputs: [{ internalType: "uint32", name: "newRewardsPPM", type: "uint32" }],
        name: "setPOLRewardsPPM",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    },
